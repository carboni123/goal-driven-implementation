---
name: gdi-reviewer
description: Verify-class read-only reviewer for goal-driven implementation sections and final whole-branch gates (goal-driven-implementation skill). Dimensions security/authz, data/migration, contract/API, failure-mode/reliability, and final-review integration lenses.
model: opus
effort: medium
...
effort pinned in frontmatter: review depth is the highest-yield token spend in
